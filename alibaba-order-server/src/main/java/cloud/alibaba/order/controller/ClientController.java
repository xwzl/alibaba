...
import cloud.alibaba.order.controller.server.ClientServer;
...
public class ClientController {
    ...
    public String increaseRestTemplate() {
        String forObject = restTemplate.getForObject("http://server/hello?name=haha", String.class);
        return forObject;
    }
